...
|Monday, January 20, 2020 |3   |College closed: holiday                                                                                                                                                                                                                                                                                                       |                                                                             |                   |Post-Investigation Questions and Investigation 1 Wrap-up; Check in with me about Investigation 2-5 design if you didn't during Week 2 Lab                                                                        |D2L-→Course Content-→Lab Handouts/Assignments                                                                |D2L-→Course Content-→Lab Handouts/Assignments Dropbox                                                                                                     |
|Monday, January 27, 2020 |4   |1) Biofuel Investigations 2-5 (each group will do one of these) ; 2) Share data with the class; 3) Each student will complete Data Analysis and Interpretation of Results for ALL Investigations 2-5; 4) Create an optimized protocol for Investigation 6 next week.                                                          |All Handouts and Textbook/Lab manual chapter on enzymes                      |Quiz 2             |Due at the Beginning of Lab: Pre-Investigation Question for your specific Investigation (2 3 or 4)  - one per group; Due at End of Lab: Investigation 2-5 Wrap-up (email is sufficient)                          |Questions: D2L-→Course Content-→Lab Handouts/Assignments;                                                    |Investigations 2-5 Wrap-Up: D2L → Course Content → Lab Handouts?Assignments Dropbox                                                                       |
|Monday, February 3, 2020 |5   |1. Biofuels Investigation 6; 2. Data Analysis and Interpretation of Results; 3. Review all collected data from investigations 1-6 and work on the Results section of your paper.                                                                                                                                              |                                                                             |Quiz 3             |Investigation 6 Pre-Investigation – one per lab group; Biofuels Paper Introduction due in lab (see project handout for details)                                                                                  |Questions: D2L-→Course Content-→Lab Handouts/Assignments; Introduction: D2L-→Course Content-→Research Project|Questions: D2L-→Course Content-→Lab Handouts/Assignments Dropbox; Introduction: D2L-→Course Content-→Research Project Dropbox                             |
