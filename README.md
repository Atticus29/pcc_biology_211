...
|Monday, January 27, 2020 |4   |1) Biofuel Investigations 2-5 (each group will do one of these) ; 2) Share data with the class (https://docs.google.com/spreadsheets/d/1230DuJVcLuXfsywkxBYVdJZIS2gzQ1evcyxVd_CEALA/edit?usp=sharing); 3) Complete Data Analysis and Interpretation of Results for ALL Investigations 2-5; 4) Create an optimized protocol for Investigation 6 next week.|All Handouts and Textbook/Lab manual chapter on enzymes                      |Quiz 2             |Due at the Beginning of Lab: Pre-Investigation Question for your specific Investigation (2, 3, 4, or 5)  - one per group; Due at End of Lab: Investigation 2-5 Wrap-up; Make sure you talk with me about your ideas for Investigation 6|Questions: D2L→Course Content→Lab Handouts/Assignments                                                   |Investigations 2-5 Wrap-Up: D2L → Course Content → Lab Handouts/Assignments Dropbox                                                                       |
|Monday, February 3, 2020 |5   |1. Biofuels Investigation 6; 2. Data Analysis and Interpretation of Results; 3. Review all collected data from investigations 1-6 and work on the Results section of your paper.                                                                                                                                                                          |                                                                             |Quiz 3             |Investigation 6 Pre-Investigation – one per lab group; Biofuels Paper Introduction due in lab                                                                                                                                          |Questions: D2L→Course Content→Lab Handouts/Assignments; Introduction: D2L→Course Content→Research Project|Questions: D2L-→Course Content-→Lab Handouts/Assignments Dropbox; Introduction: D2L-→Course Content-→Research Project Dropbox                             |
